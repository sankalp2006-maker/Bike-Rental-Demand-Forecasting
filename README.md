...
Station-Level Insights: Identifying high-demand clusters and rebalancing needs using geospatial heatmaps.


Weather Impact Analysis: Visualizing how temperature, humidity, and rainfall affect rental behavior.
...
Data Engine: Power Query for ETL processes.

Forecasting Method: Built-in Time-Series Forecasting (Exponential Smoothing).

Metrics: Developed using DAX (Data Analysis Expressions).

Key Performance Indicators (KPIs)

Predicted vs. Actual Accuracy: Consistently high R-Squared scores (e.g., 0.88).

Error Margin: Mean Absolute Error (MAE) maintained within optimal limits (e.g., 1.2 km).
...
SANKALP SOHGAURA - MS Elevate AICTE Internship - Project.pdf: Detailed final presentation .
